...
module LESModels
   ...
   use VariableConversion_NS     , only: getVelocityGradients, getTemperatureGradient, getVelocityGradients_SELECTED
#elif defined(INCNS)
...
!
      pure subroutine Smagorinsky_ComputeViscosity (delta, dWall, Q, Q_x, Q_y, Q_z, mu, C, WallModel)
         ...
         call getVelocityGradients_SELECTED(Q,Q_x,Q_y,Q_z,U_x,U_y,U_z)
#else
         call getVelocityGradients(Q,Q_x,Q_y,Q_z,U_x,U_y,U_z)
#endif
