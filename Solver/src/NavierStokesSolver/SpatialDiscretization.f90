...
!
         ...
         !case(VSCFlux_STATE)
            ...
            do k = 0, Nz
               do j = 0, Ny
                  do i = 0, Nx
                     call ViscousFlux_SELECTED(nEqn, nGradEqn, Q(:,i,j,k),  U_x(:,i,j,k), U_y(:,i,j,k), U_z(:,i,j,k), &
